...
class I3Res50(nn.Module):
    ...
    def forward_video(self, x):
        ...
        features1, preds1 = self.forward_clip(x_list[:temporal // 2])
        features2, preds2 = self.forward_clip(x_list[temporal // 2:])
    ...
    def forward(self, inputs, inputs_type='clip'):
        if inputs_type == 'clip':
            feature, pred = self.forward_clip(inputs)
